  ...
  return (
    <>
      <div className="main">
        ...
        <button className="text-gray-50 font-bold text-xl bg-gray-800 w-52 h-14 rounded-lg mt-12 hover:-translate-y-1 hover:ease-in hover:duration-100 hover:delay-100 hover:border-1 hover:border-gray-600 hover:text-gray-600 hover:bg-gray-50">View Pricing</button>
        </main>
      </div>
    </>
  );
