...
const Steps = () => {
  return (
    <section className="border-gray-200 rounded-lg shadow-lg shadow-gray-200 border-1 mt-12 p-2 mb-6 text-center max-w-7.5xl m-auto">
      ...
      <div className="flex justify-around items-center">
        <div className="relative text-center w-86">
          <h2 className="font-bold text-18xl bg-clip-text text-transparent bg-gradient-to-b from-purple-300 to-purple-50 text-purple-300">1</h2>
        ...
        <img className="w-20 h-24" src={Arrow} alt="arrow"></img>

        <div className="relative w-96 text-center">
          <h2 className="font-bold text-18xl bg-clip-text text-transparent bg-gradient-to-b from-purple-300 to-purple-50 text-purple-300">2</h2>
          <div className="absolute bottom-20">
        ...
        <div className="relative w-86 text-center">
          <h2 className="font-bold text-18xl bg-clip-text text-transparent bg-gradient-to-b from-purple-300 to-purple-50 text-purple-300">3</h2>
          <div className="absolute bottom-20">
