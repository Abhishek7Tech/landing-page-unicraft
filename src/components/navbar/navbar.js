...
const Navbar = () => {
    const {howItWorks, faq, pricing} = useContext(ScrollContext);
    return (
        <nav className="hidden lg:flex lg:flex-row lg:justify-around lg:pt-4 lg:pb-2 lg:items-center">
            ...
            <button className="text-gray-600 text-lg font-bold border-gray-600 rounded-lg border-2 w-36 h-12 hover:-translate-y-1 hover:bg-gray-700 hover:text-gray-50 hover:ease-in hover:duration-100 hover:delay-100">Contact us</button>
        </nav>
    )
}
